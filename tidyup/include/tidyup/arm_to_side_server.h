#ifndef ARM_TO_SIDE_SERVER_H_
#define ARM_TO_SIDE_SERVER_H_
...
namespace tidyup
{
	...
	class ArmToSideServer
	{
		public:

		ArmToSideServer(ros::NodeHandle nh, std::string name, moveit::planning_interface::MoveGroup* right_arm_group,
